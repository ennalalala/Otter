...
{
#ifdef OMP_WORK
  printf("gomp_work_share_end_cancel\n");
#endif
  struct gomp_thread *thr = gomp_thread ();
  struct gomp_team *team = thr->ts.team;
  gomp_barrier_state_t bstate;
...
{
#ifdef OMP_WORK
  printf("gomp_work_share_end_nowait\n");
#endif
  struct gomp_thread *thr = gomp_thread ();
  struct gomp_team *team = thr->ts.team;
