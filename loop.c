...
extern unsigned long long work_iter_num;
...
{
  //printf("start = %ld, end = %ld, incr = %ld, sched = %d, chunk_size = %ld\n", start, end, incr, sched, chunk_size);
  work_iter_num = (end - start) / incr;
  ws->sched = sched;
...
{
  //printf("gomp_parallel_loop_start\n");
...
{
  //printf("GOMP_parallel_loop_static_start\n");
...
{
  printf("GOMP_parallel_loop_static\n");
  gomp_parallel_loop_start (fn, data, num_threads, start, end, incr,
